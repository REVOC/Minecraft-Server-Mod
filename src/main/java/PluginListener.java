...
public class PluginListener {
	...
	/**
	 * Called when a player calls /me. If you return true the emote won't be
	 * sent out.
	 * 
	 * @param player
	 * @param emote
	 * @return false if you want the emote to be sent.
	 */
	public boolean onEmote(Player player, String message) {
		return false;
	}
